...
public class JMegaHal implements Serializable {
    ...
    private final static Logger logger = org.slf4j.LoggerFactory.getLogger(JMegaHal.class);
    ...
    public void add(String sentence) {
        ...
        if (parts.size() >= 4) {
            for (i = 0; i < parts.size() - 3; i++) {
                ...
                logger.info("Working with quad: {}", quad);
                ...
                for (int n = 0; n < 4; n++) {
                    ...
                    set.add(quad);
                    logger.info("Added token-to-quad association: {} / {}", token, quad );
                }
                ...
                if (i > 0) {
                    ...
                    logger.info("Added quad-to-previous-token association: {} / {}", quad, previousToken );
                }
                ...
                if (i < parts.size() - 4) {
                    ...
                    set.add(nextToken);
                    logger.info("Added quad-to-next-token association: {} / {}", quad, nextToken );
                }
    ...
    public String getSentence(String word) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            logger.info("Added part: '{}'", quad.getToken(i));
        }
        ...
        while (quad.canEnd() == false) {
            ...
            parts.add(nextToken);
            logger.info("Added end: {}", nextToken);
        }
        ...
        while (quad.canStart() == false) {
            ...
            logger.info("Added beginning: {}", previousToken );
        }
        ...
        logger.info("Constructed sentence: {}", sentence.toString());
